...
type TimeSeriesFormulaAndFunctionProcessQueryDefinition struct {
	Aggregator *FormulaAndFunctionsAggregation           `json:"aggregator,omitempty"`
	DataSource FormulaAndFunctionsProcessQueryDataSource `json:"data_source"`
	...
	Sort *FormulaAndFunctionOrder `json:"sort,omitempty"`
...
func NewTimeSeriesFormulaAndFunctionProcessQueryDefinition(dataSource FormulaAndFunctionsProcessQueryDataSource, metric string) *TimeSeriesFormulaAndFunctionProcessQueryDefinition {
...
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetAggregator() FormulaAndFunctionsAggregation {
	if o == nil || o.Aggregator == nil {
		var ret FormulaAndFunctionsAggregation
		return ret
	}
	return *o.Aggregator
}
...
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetAggregatorOk() (*FormulaAndFunctionsAggregation, bool) {
	if o == nil || o.Aggregator == nil {
		return nil, false
	}
...
// SetAggregator gets a reference to the given FormulaAndFunctionsAggregation and assigns it to the Aggregator field.
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) SetAggregator(v FormulaAndFunctionsAggregation) {
	o.Aggregator = &v
}

// GetDataSource returns the DataSource field value
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetDataSource() FormulaAndFunctionsProcessQueryDataSource {
	if o == nil {
		var ret FormulaAndFunctionsProcessQueryDataSource
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetDataSourceOk() (*FormulaAndFunctionsProcessQueryDataSource, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) SetDataSource(v FormulaAndFunctionsProcessQueryDataSource) {
	o.DataSource = v
}
...
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetSort() FormulaAndFunctionOrder {
	if o == nil || o.Sort == nil {
...
// and a boolean to check if the value has been set.
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) GetSortOk() (*FormulaAndFunctionOrder, bool) {
	if o == nil || o.Sort == nil {
		return nil, false
	}
	return o.Sort, true
...
// SetSort gets a reference to the given FormulaAndFunctionOrder and assigns it to the Sort field.
func (o *TimeSeriesFormulaAndFunctionProcessQueryDefinition) SetSort(v FormulaAndFunctionOrder) {
	o.Sort = &v
}
