...
// FormulaAndFunctionQueryDefinition - Define a formula and function query.
type FormulaAndFunctionQueryDefinition struct {
	...
	TimeSeriesFormulasAndFunctionEventQueryDefinition  *TimeSeriesFormulasAndFunctionEventQueryDefinition
}
...
// TimeSeriesFormulasAndFunctionEventQueryDefinitionAsFormulaAndFunctionQueryDefinition is a convenience function that returns TimeSeriesFormulasAndFunctionEventQueryDefinition wrapped in FormulaAndFunctionQueryDefinition
func TimeSeriesFormulasAndFunctionEventQueryDefinitionAsFormulaAndFunctionQueryDefinition(v *TimeSeriesFormulasAndFunctionEventQueryDefinition) FormulaAndFunctionQueryDefinition {
	return FormulaAndFunctionQueryDefinition{TimeSeriesFormulasAndFunctionEventQueryDefinition: v}
}
...
func (dst *FormulaAndFunctionQueryDefinition) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into TimeSeriesFormulasAndFunctionEventQueryDefinition
	err = json.Unmarshal(data, &dst.TimeSeriesFormulasAndFunctionEventQueryDefinition)
	if err == nil {
		jsonTimeSeriesFormulasAndFunctionEventQueryDefinition, _ := json.Marshal(dst.TimeSeriesFormulasAndFunctionEventQueryDefinition)
		if string(jsonTimeSeriesFormulasAndFunctionEventQueryDefinition) == "{}" { // empty struct
			dst.TimeSeriesFormulasAndFunctionEventQueryDefinition = nil
		} else {
			match++
		}
	} else {
...
func (src FormulaAndFunctionQueryDefinition) MarshalJSON() ([]byte, error) {
	...
	if src.TimeSeriesFormulasAndFunctionEventQueryDefinition != nil {
		return json.Marshal(&src.TimeSeriesFormulasAndFunctionEventQueryDefinition)
	}
...
func (obj *FormulaAndFunctionQueryDefinition) GetActualInstance() interface{} {
	...
	if obj.TimeSeriesFormulasAndFunctionEventQueryDefinition != nil {
		return obj.TimeSeriesFormulasAndFunctionEventQueryDefinition
	}
