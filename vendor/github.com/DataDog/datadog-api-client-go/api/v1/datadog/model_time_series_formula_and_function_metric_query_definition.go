...
// TimeSeriesFormulaAndFunctionMetricQueryDefinition Timeseries formula and functions metrics query.
...
func (o *TimeSeriesFormulaAndFunctionMetricQueryDefinition) GetAggregator() FormulaAndFunctionsAggregation {
...
func (o *TimeSeriesFormulaAndFunctionMetricQueryDefinition) GetAggregatorOk() (*FormulaAndFunctionsAggregation, bool) {
	if o == nil || o.Aggregator == nil {
		return nil, false
	}
...
func (o *TimeSeriesFormulaAndFunctionMetricQueryDefinition) SetAggregator(v FormulaAndFunctionsAggregation) {
	o.Aggregator = &v
}
